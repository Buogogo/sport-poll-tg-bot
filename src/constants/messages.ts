...
export const MESSAGES = {
  ...
  STATUS_INSTRUCTIONS: [
    "• Використовуйте опитування вище для голосу за себе",
    "• Щоб запросити когось викорустовуйте команди:",
    "  <code>/+</code> - додати 1 анонімний голос",
    "  <code>/+ 2</code> - додати 2 анонімних голоси",
    "  <code>/+ Нікіта, Іван</code> - додати голоси від імені людей",
    "  <code>/- 2</code> - відкликати 2-гий за номером голос\n",
  ].join("\n"),
