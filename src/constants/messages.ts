...
export const MESSAGES = {
  ...
  TARGET_ALREADY_REACHED: "🎯 Ціль вже досягнуто! Опитування завершено.",
  ...
  STATUS_INSTRUCTIONS: [
    ...
    "• Щоб додати гостей, пишіть:",
    "  <code>+</code> щоб додати 1 анонімний голос",
    "  <code>+2</code> щоб додати 2 анонімних голоси",
    "  <code>+ Нікіта, Саша</code> щоб додати голоси від імені людей",
    "  <code>-5</code> щоб відкликати 5-ий голос за номером зі списку\n",
  ].join("\n"),
